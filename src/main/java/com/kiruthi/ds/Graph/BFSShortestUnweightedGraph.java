...
public class BFSShortestUnweightedGraph {

    public static ArrayList<Integer>[] adjacencyList = null;
    public int noOfVertices;


    public BFSShortestUnweightedGraph(int noOfVertices) {
    ...
    public static void main(String[] args) {
        ...
        BFSShortestUnweightedGraph graph = new BFSShortestUnweightedGraph(3);
        graph.addEdge(1, 2);
        graph.addEdge(1, 3);
        graph.addEdge(3, 1);
        graph.addEdge(2, 1);
